...
def print_info(usr_vars, isSetUp,USER_ID,OS_SYSTEM):
    ...
    print()
    print("DETECT OUTLIARS: ", usr_vars['DETECT_OUTLIARS'])
    print("PERCENTILE: ", usr_vars['PERCENTILE'])
    print("OUTLIARS FILENAME: ", usr_vars['OUTLIARS_FILE'])
    print("OUTLIAR QC METADATA FILE: ", usr_vars['OUTLIAR_QC_METADATA_FILE'])
    print()
